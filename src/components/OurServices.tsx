...
export default function OurServices() {
  ...
  return (
    <section
      id="services"
      className="w-full pt-12 md:pt-100 bg-gradient-to-b from-white to-blue-50 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto pb-10    px-6 md:px-10 text-center">
       ...
       <p className="text-slate-700 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto mb-12 text-justify 
              bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-blue-100
              animate-fade-in">
